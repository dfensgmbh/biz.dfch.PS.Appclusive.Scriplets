...
if (!$catalogue)
{
	...
	$svc.Core.InvokeEntitySetActionWithVoidResult('SpecialOperations', "SetTenant", @{EntityId = $catalogue.Id; EntitySet = $catalogueEntitySet; TenantId = $TenantId});
}
...
if (!$catalogueItem)
{
	...
	$svc.Core.InvokeEntitySetActionWithVoidResult('SpecialOperations', "SetTenant", @{EntityId = $catalogueItem.Id; EntitySet = $catalogueItemEntitySet; TenantId = $TenantId});
}
